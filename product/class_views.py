...
class ProductDetailView(DetailView):
    model = Product     # Product.objects.get(product_id) or # Product.objects.all()
...
class ProductCreateView(IsAdminCheckMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        # чтобы в html мы могли использовать product_form вместо form,
        # для создания нескольких переменных, которые мы можем использовать в html
